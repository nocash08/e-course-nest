...
export class InitDatabase1748550417523 implements MigrationInterface {
    name = 'InitDatabase1748550417523'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "seller_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fullName" character varying(255) NOT NULL, "phoneNumber" character varying(20) NOT NULL, "address" text NOT NULL, "expertise" character varying(255) NOT NULL, "portfolio" text, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "REL_9b0517c80ecf6aadcb9e105c94" UNIQUE ("user_id"), CONSTRAINT "PK_13845670b88adfde01026410969" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "seller_profiles" ADD CONSTRAINT "FK_9b0517c80ecf6aadcb9e105c94f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
